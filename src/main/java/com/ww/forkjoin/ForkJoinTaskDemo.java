...
public class ForkJoinTaskDemo {
    ...
    private class SumTask extends RecursiveTask<Integer> {
         ...
         * 
         */
        private static final long serialVersionUID = -5747409187518784089L;
        ...
        private Integer subtotal() {
            ...
            System.out.println(Thread.currentThread().getName() + ": start = " + start + ", end =" + (end - 1) + ", sum = " + sum);
            return sum;
        }
